        ...
        return (
          <button
            ...
            style={{
              ...
              transition: "color var(--motion-fast,150ms) var(--ease-standard, cubic-bezier(.4,0,.2,1)), background-color var(--motion-fast,150ms) var(--ease-standard, cubic-bezier(.4,0,.2,1))",
